  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 1.25c-.69 0-1.25.56-1.25 1.25v.5a8.25 8.25 0 00-7 8.1v4.4a1.25 1.25 0 01-1.5 1.25 1.25 1.25 0 01-.75-1.25v-4.4A9.75 9.75 0 0112 1.25zm0 1.5a8.25 8.25 0 017 8.1v4.4a1.25 1.25 0 01-1.5 1.25H6.5a1.25 1.25 0 01-1.5-1.25v-4.4A8.25 8.25 0 0112 2.75z"
        fill="currentColor"
      />
      <path
        d="M9 18.25a3 3 0 106 0 .75.75 0 011.5 0 4.5 4.5 0 11-9 0 .75.75 0 011.5 0z"
        fill="currentColor"
      />
    </svg>
  );
